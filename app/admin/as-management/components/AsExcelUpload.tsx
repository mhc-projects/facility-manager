...
export default function AsExcelUpload({ onComplete }: AsExcelUploadProps) {
  ...
  const downloadTemplate = () => {
    ...
    const examples = [
      ['1001', '홍길동산업', '2026-01-15', '2026-01-20', 'pH계 측정값 이상', '전극 교체 및 보정', '1번 배출구', '김담당', '010-1234-5678', '블루온', '진행완료', '유상', '', '', '', 2, '1번 굴뚝'],
      ['1002', '테스트사업장', '2026-02-10', '', 'DO계 센서 불량', '', '', '이기사', '010-9876-5432', '외주업체', '현장확인', '무상', '', '', '', 1, 'A굴뚝'],
      ['', '미등록업체', '', '', '정기점검 요청', '', '', '', '', '', '진행예정', '', '서울시 강남구 테헤란로 123', '박담당', '02-1234-5678', 1, ''],
    ];
    ...
    const guideData = [
      ...
      ['상태', '선택', 'AS 진행 상태 (빈칸이면 "진행예정"으로 자동 설정)', '진행완료 / 진행예정 / 완료 / 보류 / 현장확인 / 포설 / 준공보완 / 모뎀확인'],
      ['유상/무상', '선택', '유상/무상 수동 설정 (빈칸이면 출고일 기준 자동 계산)', '유상 / 무상 / (빈칸=자동)'],
      ['사업장주소', '선택', '타업체 사업장의 주소 (블루온 등록 사업장은 시스템에서 자동 표시)', '자유 텍스트'],
      ['사업장담당자', '선택', '타업체 사업장의 담당자 이름 (블루온 등록 사업장은 시스템에서 자동 표시)', '자유 텍스트'],
      ['사업장연락처', '선택', '타업체 사업장의 연락처 (블루온 등록 사업장은 시스템에서 자동 표시)', '자유 텍스트'],
      ['출동횟수', '선택', 'AS 기사 출동 횟수 (빈칸이면 1로 자동 설정)', '숫자 (예: 1, 2, 3)'],
      ['굴뚝번호', '선택', '굴뚝 또는 배출구 번호/명칭', '자유 텍스트 (예: 1번 굴뚝, A굴뚝)'],
      [],
      ['⚠️ 주의사항'],
