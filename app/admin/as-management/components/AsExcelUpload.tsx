...
export default function AsExcelUpload({ onComplete }: AsExcelUploadProps) {
  ...
  const downloadTemplate = () => {
    ...
    const examples = [
      ['1001', '홍길동산업', '2026-01-15', '2026-01-20', 'pH계 측정값 이상', '전극 교체 및 보정', '1번 배출구', '김담당', '010-1234-5678', '블루온', '완료', '유상', '', '', '', 2],
      ['1002', '테스트사업장', '2026-02-10', '', 'DO계 센서 불량', '', '굴뚝 A', '이기사', '010-9876-5432', '외주업체', '진행중', '무상', '', '', '', 1],
      ['', '미등록업체', '', '', '정기점검 요청', '', '', '', '', '', '접수', '', '서울시 강남구 테헤란로 123', '박담당', '02-1234-5678', 1],
    ];
