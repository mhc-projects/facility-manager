...
function normalizeBusiness(business: any): UnifiedBusinessInfo {
  return {
    ...
    multiple_stack_cost: business.multiple_stack_cost || null,
    ...
    explosion_proof_differential_pressure_meter_domestic: business.explosion_proof_differential_pressure_meter_domestic || 0,
    explosion_proof_temperature_meter_domestic: business.explosion_proof_temperature_meter_domestic || 0,
    expansion_pack: business.expansion_pack || 0,
    manufacturer: getManufacturerName(business.manufacturer || '') || '',
    negotiation: business.negotiation || null,
    installation_extra_cost: business.installation_extra_cost || null,
    survey_fee_adjustment: business.survey_fee_adjustment || null,
    // 한국어 센서/장비 필드명 매핑
    ...
    이메일: business.email || '',
    // 시스템 정보 필드
    business_management_code: business.business_management_code || null,
