...
export default function WikiPage() {
  ...
  return (
    <AdminLayout title="업무 지침" description="DPF·IoT 방지시설 업무처리지침 Wiki" actions={actions}>
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        ...
        <div className="lg:col-span-1">
          ...
          <div className="mt-3 bg-white border border-gray-200 rounded-xl shadow-sm p-3">
            <div className="text-xs font-semibold text-gray-500 mb-2">DPF 공식 서식</div>
        ...
        <div className="lg:col-span-3">
          ...
          <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-5 mb-4">
            <h2 className="font-semibold text-gray-800 mb-3">자주 쓰는 DPF 서식</h2>
