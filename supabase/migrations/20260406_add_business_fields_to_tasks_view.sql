-- 업무관리 테이블에 설치완료/부착통보/그린링크 컬럼 표시를 위해
-- facility_tasks_with_business 뷰에 business_info 필드 추가
-- 기존 20260330 마이그레이션의 뷰 구조를 유지하면서 필드만 추가
...
COMMENT ON VIEW facility_tasks_with_business IS
  'task_type은 business_info.progress_status에서 실시간 파생됨. 설치완료/부착통보/그린링크 필드 포함.';
