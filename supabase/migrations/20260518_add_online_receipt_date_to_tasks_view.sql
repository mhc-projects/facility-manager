-- facility_tasks_with_business 뷰에 online_receipt_date 필드 추가
...
SELECT
  ...
  -- 부착지원신청서 필드
  b.attachment_support_writing_date,
  b.attachment_support_application_date,
  -- 온라인 접수일
  b.online_receipt_date,
  -- 생성자/수정자 정보
...
COMMENT ON VIEW facility_tasks_with_business IS
  'task_type은 business_info.progress_status에서 실시간 파생됨. 설치완료/부착통보/그린링크/제조사/부착지원신청서/영업점/VPN/온라인접수일 필드 포함.';
